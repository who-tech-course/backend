...
INSERT INTO "new_MissionRepo" ("candidateReason", "cohortRegexRules", "description", "githubRepoId", "id", "name", "nicknameRegex", "repoUrl", "status", "track", "type", "workspaceId") SELECT "candidateReason", "cohortRegexRules", "description", "githubRepoId", "id", "name", "nicknameRegex", "repoUrl", "status", "track", "type", "workspaceId" FROM "MissionRepo";
